...
const BackNavigationIcon = () => (
    <svg
        ...
        data-test="back-navigation-icon"
    >
        <path
...
const MultiDirectionNavigationIcon = () => (
    <svg
        ...
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
        data-test="multi-direction-navigation-icon"
    >
        <path
...
const VerticalNavigationIcon = () => (
    <svg
        ...
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
        data-test="vertical-navigation-icon"
    >
        <path
