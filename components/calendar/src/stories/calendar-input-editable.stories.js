...
import { CalendarInputEditable } from '../calendar-input/calendar-input-editable.js'
...
const description = `
Use a CalendarInputEditable where there is a need to let the user input a date.

Note that it requires a parent, like [Box](../?path=/docs/layout-box--default), to define its size.

\`\`\`js
import { CalendarInputEditable } from '@dhis2/ui'
\`\`\`
`

export default {
    title: 'CalendarInputEditable',
    component: CalendarInputEditable,
    parameters: {
