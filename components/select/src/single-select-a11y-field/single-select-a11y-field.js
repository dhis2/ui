...
import { SingleSelectA11y, optionProp } from '../single-select-a11y/index.js'

export function SingleSelectA11yField(props) {
    const {
        className,
        dataTest,
        disabled,
    ...
    return (
        <Field
            ...
            valid={valid}
        >
            <SingleSelectA11y {...props} labelledBy={labelId} />
        </Field>
    )
}
