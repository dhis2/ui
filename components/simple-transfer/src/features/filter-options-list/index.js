...
Given('the result is not empty', () => {
    cy.visitStory('SimpleTransfer filtering', 'Some Results')
})

Given('the result is empty', () => {
    cy.visitStory('SimpleTransfer filtering', 'Empty Result')
})
...
Given(
    ...
    (firstCase) => {
        if (firstCase === 'uppercase') {
            cy.visitStory('SimpleTransfer filtering', 'Uppercase Search')
...
Given('the filter function only returns ANC options', () => {
    cy.visitStory('SimpleTransfer filtering', 'Anc Custom Filter')
})

Given("the filter value is controlled by the component's consumer", () => {
    cy.visitStory('SimpleTransfer filtering', 'Controlled Filter')
})
