...
Given('the option list has one or more items', () => {
    cy.visitStory('SimpleTransfer highlight range of options', 'Has Options')
...
Given('the selected list has one or more items', () => {
    cy.visitStory('SimpleTransfer highlight range of options', 'Has Selected')
...
Given('the selected list has many items', () => {
    cy.visitStory('SimpleTransfer highlight range of options', 'All Selected')
    cy.get('{transfer-pickedoptions}')
        .as('list')
        .as('list')
        .find('{transferoption}')
