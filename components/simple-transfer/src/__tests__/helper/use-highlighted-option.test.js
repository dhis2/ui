...
import { useHighlightedOptions } from '../../simple-transfer/use-highlighted-options.js'

jest.mock(
    '../../simple-transfer/use-highlighted-options/create-toggle-highlighted-option.js',
    () => ({
...
describe('SimpleTransfer - useHighlightedOptions', () => {
