...
import { createToggleHighlightedOption } from '../../../simple-transfer/use-highlighted-options/create-toggle-highlighted-option.js'
import { toggleAdd } from '../../../simple-transfer/use-highlighted-options/toggle-add.js'
import { toggleRange } from '../../../simple-transfer/use-highlighted-options/toggle-range.js'
import { toggleReplace } from '../../../simple-transfer/use-highlighted-options/toggle-replace.js'

jest.mock(
    '../../../simple-transfer/use-highlighted-options/toggle-add.js',
    () => ({
        toggleAdd: jest.fn(),
    })
)
...
jest.mock(
    '../../../simple-transfer/use-highlighted-options/toggle-range.js',
    () => ({
        toggleRange: jest.fn(),
    })
)
...
jest.mock(
    '../../../simple-transfer/use-highlighted-options/toggle-replace.js',
    () => ({ toggleReplace: jest.fn() })
)

describe('SimpleTransfer- useHighlightedOptions - createToggleHighlightedOption', () => {
