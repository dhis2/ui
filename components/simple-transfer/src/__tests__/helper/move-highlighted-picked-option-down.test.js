import { moveHighlightedPickedOptionDown } from '../../simple-transfer/move-highlighted-picked-option-down.js'

describe('SimpleTransfer - moveHighlightedPickedOptionDown', () => {
