...
export const Basic = () => (
    <Button name="Basic button" value="default" onClick={logger}>
        Label me!
    </Button>
)

export const Primary = () => (
    <Button primary name="Primary button" value="default" onClick={logger}>
        Label me!
    </Button>
)

export const Secondary = () => (
    <Button secondary name="Secondary button" value="default" onClick={logger}>
        Label me!
    </Button>
)
...
export const Small = () => (
    <Button small name="Small button" value="default" onClick={logger}>
        Label me!
    </Button>
)

export const Large = () => (
    <Button large name="Large button" value="default" onClick={logger}>
        Label me!
    </Button>
)
