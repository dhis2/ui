...
export const TableRowExpandables = () => {
    const style = {
        margin: 8,
        padding: 4,
        backgroundColor: 'lightblue',
    ...
    return (
        <Table>
            ...
            <TableBody>
                <TableRowExpandable expandableContent={expandableContent}>
                    <TableCell>Onyekachukwu</TableCell>
                    <TableCell>Kariuki</TableCell>
                    <TableCell>02/06/2007</TableCell>
                    <TableCell>05/25/1972</TableCell>
...
export const InlineFiltering = () => {
    ...
    const onFilterIconClick = ({ name, active }) => {
        setVisibility({
            ...visibility,
            [name]: active,
        })
