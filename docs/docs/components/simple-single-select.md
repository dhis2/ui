...
-   The error text should help the user fix the problem. Refer to the [error writing guidelines](https://developers.dhis2.org/design-system/principles/content-communication#error-messages) for examples.
